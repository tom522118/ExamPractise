...
with open(".\data\成語集_2023高年級組_ver2.csv", 'r', encoding='big5', errors='ignore') as x:
...
class Main(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.save_log_name = datetime.now().strftime("%Y_%m_%d-%I_%M_%S_%p")+'_C1.csv'
        ...
        parent_layout.setContentsMargins(90, 455, 90, 90)
    ...
    def restart(self):         
        ...
        quiz_msg = """<font color='blue'><b>{0}</b></font>
            ...
            """.format(self.QA_list[self.Answer_int-1][2]) 
...
if __name__ == '__main__':
    ...
    app.setApplicationDisplayName("看定義選成語")
    w = Main()
    w.showMaximized()
    sys.exit(app.exec_())